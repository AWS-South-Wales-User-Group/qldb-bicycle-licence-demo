...
const { getEndorsementHistory } = require('./helper/licence');
...
const handler = async (event) => {
  ...
  logger.debug(`In the get-endorsement-history handler with licenceid ${licenceid}`);

  try {
    const response = await getEndorsementHistory(logger, licenceid);
